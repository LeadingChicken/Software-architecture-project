  ...
  return (
    <Container className={`"text-center px-auto"`}>
      ...
      >
        ...
        >
          <h1
            className={`${styles.cardHeader} display-3`}
          ...
          <Row className="ms-auto me-auto">
            <Col>
              <p className={`${styles.sky}  `}>Moves: {moveCount}</p>
            </Col>
            <Col className="text-right">
              <p className={styles.sky}>
                Correct Pairs: {matchedCards.length / 2}
              </p>
            </Col>
          </Row>
        </Card.Header>
        <Card.Body>
          ...
          <Row className="justify-content-center">
            <Button
              onClick={resetGame}
              className="mt-3 w-50 border rounded"
              style={{
                backgroundColor: "#1e1e1e", // Màu nút
                color: "white",
            ...
            >
              <span className={`${styles.cardHeader} display-6`}>Restar</span>
            </Button>
          </Row>
        </Card.Body>
      </Card>
